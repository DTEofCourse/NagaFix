...
@Mod("nagafix")
public class NagafixMod {
	public static final Logger LOGGER = LogManager.getLogger(NagafixMod.class);
	public static final String MODID = "nagafix";

	public NagafixMod(FMLJavaModLoadingContext context) {
